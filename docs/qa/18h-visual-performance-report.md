...
Известная деградация: hover-подсветка слитой мебели больше не
подсвечивает сами меши (курсор-указатель сохраняется, триггеры живы).
Кандидаты на следующий проход: статика Kitchen/GameRoom/MeetingRoom/
ServerRoom (~минус ещё 200-300 calls), инстансинг персонажных теней.
